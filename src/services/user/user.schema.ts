...
export const userDataSchema = Type.Omit(userSchema, ['id', 'mobileVerifiedAt', 'emailVerifiedAt'], {
  $id: 'UserData'
})
...
export const userDataResolver = resolve<User, HookContext>({
  ...
  password: passwordHash({ strategy: 'login' }),
  passphrase: passwordHash({ strategy: 'login' })
})
...
export const userPatchResolver = resolve<User, HookContext>({
  ...
  passphrase: passwordHash({ strategy: 'local' })
})

// Schema for allowed query properties
export const userQueryProperties = Type.Pick(userSchema, ['id', 'mobile', 'email'])
