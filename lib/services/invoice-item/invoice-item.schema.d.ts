...
export declare const invoiceItemSchema: import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
}>;
export type InvoiceItem = Static<typeof invoiceItemSchema>;
export declare const invoiceItemValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const invoiceItemResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
}, HookContext>;
export declare const invoiceItemExternalResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
}, HookContext>;
export declare const invoiceItemDataSchema: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
}>, ["text"]>;
export type InvoiceItemData = Static<typeof invoiceItemDataSchema>;
export declare const invoiceItemDataValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const invoiceItemDataResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
}, HookContext>;
export declare const invoiceItemPatchSchema: import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
}>>;
export type InvoiceItemPatch = Static<typeof invoiceItemPatchSchema>;
export declare const invoiceItemPatchValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const invoiceItemPatchResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
}, HookContext>;
export declare const invoiceItemQueryProperties: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
}>, ["id", "text"]>;
export declare const invoiceItemQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
...
export declare const invoiceItemQueryValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const invoiceItemQueryResolver: import("@feathersjs/schema").Resolver<Partial<{
    $limit: number;
    $skip: number;
    $sort: {
        id?: number | undefined;
